...
json_t *json_string_nocheck_ex(const char *value, size_t len, size_t flags)
{
    ...
    dup = steal_or_copy(value, len, flags);
    if(!dup)
        return NULL;
...
json_t *json_string_ex(const char *value, size_t len, size_t flags)
{
    ...
    return json_string_nocheck_ex(value, len, flags);
}
...
int json_string_set_nocheck(json_t *json, const char *value)
{
    ...
    return json_string_set_nocheck_ex(json, value, strlen(value), 0);
}

int json_string_set_nocheck_ex(json_t *json, const char *value, size_t len, size_t flags)
{
    char *dup;
    json_string_t *string;
...
int json_string_set(json_t *json, const char *value)
{
    ...
    return json_string_set_ex(json, value, strlen(value), 0);
}

int json_string_set_ex(json_t *json, const char *value, size_t len, size_t flags)
{
    if(!value || !utf8_check_string(value, len))
        return -1;

    return json_string_set_nocheck_ex(json, value, len, flags);
}
...
static int json_string_equal(json_t *string1, json_t *string2)
{
    ...
    return s1->len == s2->len && !memcmp(s1->value, s2->value, s1->len);
}
...
static json_t *json_string_copy(const json_t *string)
{
    ...
    return json_string_nocheck_ex(json_string_value(string), json_string_len(string), 0);
}
